...
let nameSongs = [
	...
	"FIRST DATE", /*3*/
	"ADAM'S SONG", /*4*/
	"STAY TOGETHER FOR THE KIDS", /*5*/
	"I MISS YOU", /*6*/
	"ONE MORE TIME", /*7*/
	"DAMMIT", /*8*/
	"GOING AWAY TO COLLEGE", /*9*/
	"ANTHEM PART TWO", /*10*/
	"GHOST ON THE DANCE FLOOR", /*11*/
	"AFTER MIDNIGHT", /*12*/
	"DISASTER LYRICS", /*13*/
	"PRETTY LITTLE GIRL", /*14*/
	"UP ALL NIGHT", /*15*/
	"BORED TO DEATH", /*16*/
	"VIOLENCE", /*17*/
	"DUMPWEED", /*18*/
	"MUTT", /*19*/
	"EVERYTIME I LOOK FOR YOU", /*20*/
]
